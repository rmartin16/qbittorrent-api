...
class Application(ClientCache):
    ...
    @preferences.setter
    def preferences(self, value: Mapping) -> None: ...
    def set_preferences(self, prefs: Mapping = None, **kwargs) -> None: ...
...
class AppAPIMixIn(Request):
    ...
    def app_set_preferences(self, prefs: Mapping = None, **kwargs) -> None: ...
