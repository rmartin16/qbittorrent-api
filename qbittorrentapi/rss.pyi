...
class RSSitemsDictionary(Dictionary[K, V]): ...
class RSSRulesDictionary(Dictionary[K, V]): ...

class RSS(ClientCache):
    items: _Items
    def __init__(self, client: RSSAPIMixIn) -> None: ...
    def add_folder(
        self, folder_path: Optional[Text] = None, **kwargs: KWARGS
    ) -> None: ...
    ...
    addFeed = add_feed
    def remove_item(
        self, item_path: Optional[Text] = None, **kwargs: KWARGS
    ) -> None: ...
    ...
    def remove_rule(
        self, rule_name: Optional[Text] = None, **kwargs: KWARGS
    ) -> None: ...
    removeRule = remove_rule
    @property
    def rules(self) -> RSSRulesDictionary[Text, JsonValueT]: ...
    ...
    class _Items(ClientCache):
        def __call__(
            self, include_feed_data: Optional[bool] = None, **kwargs: KWARGS
        ) -> RSSitemsDictionary[Text, JsonValueT]: ...
        @property
        def without_data(self) -> RSSitemsDictionary[Text, JsonValueT]: ...
        @property
        def with_data(self) -> RSSitemsDictionary[Text, JsonValueT]: ...
...
class RSSAPIMixIn(AppAPIMixIn):
    ...
    def rss_rules(self, **kwargs: KWARGS) -> RSSRulesDictionary[Text, JsonValueT]: ...
