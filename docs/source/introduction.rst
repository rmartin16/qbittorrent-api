...
Currently supports up to qBittorrent `v4.3.3 <https://github.com/qbittorrent/qBittorrent/releases/tag/release-4.3.3>`_ (Web API v2.7) released on January 18, 2021.
