...
Currently supports up to qBittorrent `v4.4.3 <https://github.com/qbittorrent/qBittorrent/releases/tag/release-4.4.3>`_ (Web API v2.8.5) released on May 22, 2022.
