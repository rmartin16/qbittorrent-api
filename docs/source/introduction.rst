...
Currently supports up to qBittorrent `v4.4.2 <https://github.com/qbittorrent/qBittorrent/releases/tag/release-4.4.2>`_ (Web API v2.8.5) released on Mar 22, 2022.
