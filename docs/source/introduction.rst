...
Currently supports up to qBittorrent `v4.3.5 <https://github.com/qbittorrent/qBittorrent/releases/tag/release-4.3.5>`_ (Web API v2.8.2) released on May 2, 2021.
